...
const embed = new MessageEmbed().setColor("RANDOM").setTimestamp().setTitle(type).setDescription(content).setFooter("râvenn#1986")
...
client.user.setPresence({ activity: { type: "COMPETING", name: `râvenn#1986`}, status: 'dnd' });
})
